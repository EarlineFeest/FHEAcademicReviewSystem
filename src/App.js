...
function App() {
  ...
  const defaultPapers = [
    {
      ...
      abstract:
        "This paper presents a novel approach to academic peer review that ensures complete privacy of reviewers and their evaluations through FHE technology. Our system enables anonymous voting while maintaining the integrity and transparency of the review process.",
    ...
    },
    {
      ...
      abstract:
        "We introduce a decentralized system for verifying academic publications using blockchain technology and zero-knowledge proofs. This ensures authenticity while preserving author privacy during the review process.",
    ...
    },
    {
      ...
      abstract:
        "This work proposes a secure multi-party computation protocol for collaborative research evaluation, enabling multiple reviewers to jointly assess research without revealing individual opinions or biases.",
    ...
    },
    {
      ...
      abstract:
        "We design game-theoretic incentive mechanisms that encourage honest and thorough peer review in decentralized academic publishing systems, addressing the free-rider problem in academic evaluation.",
    ...
    },
    {
      ...
      abstract:
        "This paper explores the application of differential privacy techniques to academic peer review systems, providing mathematical guarantees for reviewer anonymity while maintaining system transparency and accountability.",
    ...
    },
    {
      ...
      abstract:
        "We present a comprehensive smart contract architecture for managing academic journals on blockchain, including submission, review assignment, evaluation aggregation, and publication processes with full transparency.",
  ...
  const initializeProvider = async () => {
    if (typeof window.ethereum !== "undefined") {
      try {
        ...
        const fheContract = new ethers.Contract(FHE_CORE_ADDRESS, FHE_CORE_ABI, provider);
  ...
  const loadUserData = async (userAccount) => {
    ...
    try {
      ...
      try {
        ...
        console.log(
          "User paper IDs:",
          userPaperIds.map((id) => Number(id))
        );
        setMyPapers(
          updatedPapers.filter((p) => userPaperIds.map((id) => Number(id)).includes(p.id))
        );
      } catch (error) {
    ...
    try {
      ...
      if (reviewContract && provider) {
        try {
          ...
          if (code !== "0x") {
            const tx = await contractWithSigner.submitPaper(paperTitle, paperAbstract, paperIpfs, {
              gasLimit: 500000,
            });
  ...
  const submitReview = async () => {
    ...
    try {
      ...
      toast.success(
        `🎉 Anonymous review submitted! Block: ${receipt.blockNumber}. Your score (${reviewScore}/10) is encrypted on-chain.`,
        {
          id: "submit-review",
          duration: 8000,
        }
  ...
  const revealPaperScore = async (paperId) => {
    ...
    try {
      ...
      toast.success(`🎉 FHE Decryption Complete! Average Score: ${averageScore}/10 (Demo Mode)`, {
        id: "reveal-score",
        duration: 8000,
      });
              ...
              <div className="flex-shrink-0 flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Decentralized Privacy-Preserving Voting System
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center py-16">
            <div className="max-w-2xl mx-auto">
              ...
              <h3 className="text-xl font-medium text-gray-700 mb-6">
                Decentralized Privacy-Preserving Voting
              </h3>
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-8 mb-8">
                <p className="text-gray-600 mb-4 leading-relaxed">
                  🔒 <strong>Anonymous Voting:</strong> Submit and review academic papers with
                  complete privacy protection through Fully Homomorphic Encryption
                </p>
                <p className="text-gray-600 mb-4 leading-relaxed">
                  🏛️ <strong>Decentralized System:</strong> Blockchain-based peer review ensuring
                  transparency and preventing manipulation
                </p>
                <p className="text-gray-600 mb-4 leading-relaxed">
                  ⚡ <strong>Real Blockchain:</strong> Built on Ethereum Sepolia testnet with
                  genuine on-chain transactions
                </p>
                <p className="text-gray-600 leading-relaxed">
                  🎯 <strong>Academic Focus:</strong> Designed specifically for scholarly research
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg shadow-sm p-6 border border-blue-100">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Submit your research for anonymous peer review
                </p>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Upload your paper to IPFS and enter the hash here
                    </p>
                  </div>
                  <button
                    onClick={submitPaper}
                ...
                {reviewerInfo ? (
                  <div className="space-y-2">
                    <p className="text-sm text-gray-600">
                      Status:
                      <span
                        className={`ml-1 font-medium ${reviewerInfo.isVerified ? "text-green-600" : "text-yellow-600"}`}
                      >
              ...
              {reviewerInfo && reviewerInfo.isVerified && (
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg shadow-sm p-6 border border-purple-100 review-form">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Your review will be encrypted using FHE technology
                  </p>
                  <div className="space-y-4">
                    <input
                      type="number"
                  ...
                  {papers.length > 0 ? (
                                  ...
                                  onClick={() => {
                                    ...
                                    setTimeout(() => {
                                      ...
                                      if (reviewForm) {
                                        ...
                                        const firstInput =
                                          reviewForm.querySelector('input[type="number"]');
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-400 text-sm">
                        Submit your research for peer review to get started
                      </p>
                    </div>
                  )}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center md:text-left">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Decentralized privacy-preserving voting system for academic research evaluation
                using blockchain technology and Fully Homomorphic Encryption.
              </p>
            </div>
          ...
          <div className="border-t border-gray-200 mt-8 pt-6">
            <div className="text-center text-sm text-gray-500">
              <p className="mb-2">
                🎯 <strong>Academic Peer Review System</strong> - Advancing scholarly research
                through blockchain technology
              </p>
              <p className="text-xs">
                Built for transparent, secure, and privacy-preserving academic evaluation • Powered
                by Ethereum & FHE
              </p>
            </div>
          </div>
